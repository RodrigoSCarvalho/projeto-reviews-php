...
<body>
    ...
    <div class="row d-flex text-center justify-content-center">
        <div class="col d-flex justify-content-center">
            <form action="http://review.com/Genre/gravarAlterar" method="POST">
                <div class="mb-3">
                    <h1 class="display-4 sombra text-warning"> Alterar - Gênero </h1>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="nome" class="form-control" id="genero" name="genero" value="<?= $genero['genero'] ?>">
                </div>

                <button type="submit" name="bt_acao" value="alterar" class="btn btn-light">Alterar</button>
