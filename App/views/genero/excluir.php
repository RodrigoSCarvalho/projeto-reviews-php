...
<body>
    ...
    <div class="row d-flex text-center justify-content-center">
        <div class="col d-flex justify-content-center">
            <form action="http://review.com/Genre/gravarExcluir" method="POST">
                <div class="mb-3">
                    <h1 class="display-4 sombra text-warning"> Excluir - Gênero </h1>
                </div>
                <input type="hidden" id="token_csrf" name="CSRF_token" value="<?= $_SESSION['CSRF_token'] ?>" />
                <input type="hidden" id="id" name="id" value="<?= $genero['id'] ?>" />
                <div class="form-group mb-3">
                    <label for="nome" class="text-light mb-1">Gênero</label>
                    <input type="nome" class="form-control" id="genero" name="genero" readonly value="<?= $genero['genero'] ?>">
                </div>

                <button type="submit" name="bt_acao" value="excluir" class="btn btn-light">Excluir</button>
